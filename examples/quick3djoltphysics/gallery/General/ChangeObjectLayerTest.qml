...
Item {
    ...
    function prePhysicsUpdate(frameDelta) {
        ...
        if (time >= 2) {
            isDebris = !isDebris;
            movingBody.setPositionAndRotation(Qt.vector3d(0, 1.5, 0), Qt.vector3d(0, 0, 0));
            ...
            for (var i = 0; i < 50; ++i) {
                ...
                body.setPositionAndRotation(Qt.vector3d(randomX, 2.0, randomY), rotation.toEulerAngles());
            }
