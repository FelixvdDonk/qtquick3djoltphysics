...
void ExampleContactListener::contactAdded(const BodyContact &bodyContact, ContactSettings &settings)
{
...
void ExampleContactListener::contactPersisted(const BodyContact &bodyContact, ContactSettings &settings)
{
