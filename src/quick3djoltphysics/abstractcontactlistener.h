...
public:
    ...
    using BodyContactManifoldPair = QPair<BodyContact, ContactManifold>;
    ...
    virtual void contactAdded(const BodyContact &bodyContact, ContactSettings &settings) = 0;
    virtual void contactPersisted(const BodyContact &bodyContact, ContactSettings &settings) = 0;
