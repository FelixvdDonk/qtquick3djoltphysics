...
class Q_QUICK3DJOLTPHYSICS_EXPORT SliderConstraint : public AbstractPhysicsConstraint
{
    ...
    Q_PROPERTY(float targetPosition READ targetPosition WRITE setTargetPosition NOTIFY targetPositionChanged)
...
signals:
    ...
    void targetVelocityChanged(float targetVelocity);
    void targetPositionChanged(float targetPosition);
